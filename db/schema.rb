...
ActiveRecord::Schema.define(:version => 20100719010223) do
  ...
  create_table "patients", :force => true do |t|
    ...
    t.string   "residential_address",             :limit => 250,                 :null => false
    t.string   "residential_address_complement",  :limit => 100,                 :null => false
    ...
    t.string   "nationality",                     :limit => 50,  :default => "", :null => false
    t.string   "professional_address",            :limit => 250
    t.string   "professional_address_complement", :limit => 250
    ...
    t.string   "surgery_performed_at",            :limit => 250
    t.text     "surgery_description"
